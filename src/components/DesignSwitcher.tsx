...
import { Palette, X, Sparkles, Zap, Leaf } from "lucide-react";
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-20 left-0 bg-background border border-white/10 p-4 rounded-3xl shadow-2xl backdrop-blur-2xl w-64 space-y-3"
          >
            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-foreground/40 px-2 pb-2 border-b border-white/5">

      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-6 group">
                <div className="w-12 h-12 rounded-2xl bg-accent/10 border border-accent/20 flex items-center justify-center shrink-0 transition-all group-hover:bg-accent group-hover:text-black">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative h-[500px] w-full rounded-[40px] overflow-hidden border border-white/10 shadow-2xl group"
          >
            {/* Custom Styled Google Map with Dark Overlay Filter */}
            <iframe
              ...
              width="100%"
              height="100%"
              style={{ border: 0, filter: "invert(90%) hue-rotate(180deg) brightness(0.95) contrast(1)" }}
            ...
            <div className="absolute inset-0 pointer-events-none border-[12px] border-background rounded-[40px] shadow-[inset_0_0_120px_rgba(0,0,0,0.8)]" />
